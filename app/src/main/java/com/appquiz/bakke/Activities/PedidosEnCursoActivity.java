...
import com.appquiz.bakke.Adapters.PedidosEnCursoAdapter;
...
public class PedidosEnCursoActivity extends AppCompatActivity {
    ...
    private String TAG = "PedidosEnCursoActivity";
    ...
    protected void onResume() {
        ...
        final ArrayList<Pedido> listaPedidosEnCurso = Repositorio.getRepositorio().consultaListarPedidosEnCurso(myContext);

        // Inicializa el RecyclerView
        final RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerView_enCurso);
        // Crea el Adaptador con los datos de la lista anterior
        final PedidosEnCursoAdapter adaptador = new PedidosEnCursoAdapter(listaPedidosEnCurso);
        ...
        if(DB_Vacia == false){
            ...
            adaptador.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(PedidosEnCursoActivity.this, DetallesPedidoActivity.class);

                    // Creamos la información a pasar entre actividades
                    Bundle b = new Bundle();
                    b.putInt("ID", listaPedidosEnCurso.get(position).getId());
